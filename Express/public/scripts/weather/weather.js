...
function handleMessage(e){
    (function getWeather(data){
        var getWeather = function callback(weatherData){
        ...
        var getWoeid = function callback(woeidData){
            ...
            request("https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid%3D"+woeid+"%20and%20u=%27c%27&format=json",getWeather);
        };
